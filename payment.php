...
/* new mail pattern */
    ...
    if(isset($_POST['submit_payment'])){
        ...
        $receipt_number = "";
        $sql_insert = $connectdb->prepare("INSERT INTO payments (tdate, pharmacy_name,  supretendent_pharmacist, payment_method, pharmacist_email, payment_evidence, pcn_payment, payment_status, receipt_number) VALUES (:tdate, :pharmacy_name, :supretendent_pharmacist, :payment_method, :pharmacist_email, :payment_evidence, :pcn_payment, :payment_status, :receipt_number)");
        ...
        if($check_user->rowCount() > 0){
            ...
            if(move_uploaded_file($_FILES['payment_evidence']['tmp_name'], $national_evidence) && move_uploaded_file($_FILES['pcn_payment']['tmp_name'], $state_evidence)){
                ...
                $sql_insert->bindvalue('pcn_payment', $pcn_payment);
